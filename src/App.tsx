          ...
          <div className="apply-yellow-layout">
            ...
            <div className="apply-form-card apply-consult-card reveal-item reveal-delay-2">
              ...
              <div className="apply-consult-checklist">
                ...
                <div className="apply-checklist-item">
                  <CheckCircle2 size={18} className="apply-check-icon" />
                  <span>메가존클라우드 인턴십 및 채용 연계 혜택 제공</span>
                </div>
                <div className="apply-checklist-item">
                  <CheckCircle2 size={18} className="apply-check-icon" />
                  <span>비전공자·초보자를 위한 맞춤형 사전 학습 및 멘토링 지원</span>
                </div>
              </div>
              ...
              >
                <div className="apply-naver-btn-left">
                  <span className="apply-naver-logo-tag">N</span>
                  <span className="apply-naver-btn-text">무료 교육 상담 신청하기</span>
                </div>
      ...
      <footer className="footer">
        <div className="container footer-inner">
          <div>
            ...
            <p>AI Campus · K-Digital Training | 교육문의 : <a href="tel:1644-7157" className="footer-tel-link" onClick={(e) => { const isMobile = window.innerWidth < 768 || /Android|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent); if (!isMobile) { e.preventDefault(); window.open('https://naver.me/FNIvuDol', '_blank', 'noopener,noreferrer'); } }}>1644-7157</a></p>
